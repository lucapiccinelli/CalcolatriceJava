...
public class Main
{
    ...
    private static void createKeyboardButtons(JPanel panel) {
    ...
    {
        JButton button = createButton("C", x, y);
        button.addActionListener(new ActionListener()
        {
            @Override
            public void actionPerformed(ActionEvent e)
    ...
    private static JButton createButton(String C, int x, int y) {
        JButton button = new JButton(C);
        button.setBounds(x, y, 70, 50);
        return button;
    }

    private static void clearTextField(JTextField inputField){
        inputField.setText("");
    }
